...
function StationMarkerComponent({ record, metric, selected, onSelect }: StationMarkerProps) {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "flex min-w-8 items-center justify-center rounded-full border-2 px-1.5 py-0.5 text-xs font-semibold tabular-nums shadow-md transition-all",
